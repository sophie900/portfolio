    ...
    <>
      <div className="h-screen flex flex-col items-start justify-end pb-30 lg:pb-40">
        ...
        <div className="flex flex-row flex-wrap z-30 gap-4">
          <a href="https://www.linkedin.com/in/sophie-rong/" target="_blank" className="text-zinc-400 dark:text-zinc-300 hover:text-zinc-500 dark:hover:text-zinc-200">
          ...
          <a href="https://github.com/sophie900" target="_blank" className="text-zinc-400 dark:text-zinc-300 hover:text-zinc-500 dark:hover:text-zinc-200">
