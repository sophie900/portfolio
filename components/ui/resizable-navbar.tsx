  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        visible && "bg-zinc-100/80 dark:bg-zinc-950/80",
        className,
      )}
    >
      {children}
...
export const MobileNavToggle = ({
  ...
  return isOpen ? (
    <IconX className="text-zinc-800 dark:text-zinc-100 hover:cursor-pointer" onClick={onClick} />
  ) : (
    <IconMenu2 className="text-zinc-800 dark:text-zinc-100 hover:cursor-pointer" onClick={onClick} />
  );
};
